		...
		<div class="modal-content">
			<form role="form" action="{c2r-path-bo}/{c2r-lg}/{c2r-module-folder}/api/?r=add-account-mov">
				...
				<div class="modal-footer taright">
					<button id="save-project" type="submit" class="btn btn-save" name="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i><div class="sm-block15"></div> {c2r-acc-mov-lg-save}</button>
