<!-- Modal -->
<div class="modal fade taleft" id="form-view-movement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form role="form" action="{c2r-path-bo}/{c2r-lg}/{c2r-module-folder}/api/?r=edit-account-mov">
				<!-- Modal Header -->
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">
					{c2r-acc-edit-mov-title}
					</h4>
				</div>
